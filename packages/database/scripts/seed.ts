  ...
  try {
    ...
    const transcriptData = [
      ...
      },
      {
        ...
        content: 'Performance is becoming increasingly important as web applications grow more complex. We dive deep into modern performance optimization techniques including code splitting, lazy loading, service workers, and the latest browser APIs. The conversation covers real-world case studies and practical tips for measuring and improving Core Web Vitals.',
        status: 'cleaned' as const,
        sourceType: 'youtube',
      ...
      },
      {
        ...
        content: 'Good database design is the foundation of any successful application. This discussion covers normalization strategies, indexing best practices, and when to denormalize for performance. We also explore modern approaches like event sourcing and CQRS patterns that can help scale complex systems.',
        status: 'raw' as const,
        sourceType: 'article',
