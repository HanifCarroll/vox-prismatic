...
function ScoreDisplay({ scores }: { scores: InsightView["scores"] }) {
	...
	return (
		<div className="flex items-center gap-3">
			...
			<div
				className={`flex items-center justify-center w-12 h-12 rounded-full font-bold text-lg ${getScoreBackground(scores.total)} ${getScoreColor(scores.total)}`}
			>
				{scores.total}
			</div>
...
export default function InsightCard({
	...
	return (
		<Card
			className={`transition-all duration-200 ${isSelected ? "border-blue-500 bg-blue-50" : "hover:shadow-md"}`}
		>
