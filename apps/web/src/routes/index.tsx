...
export const Route = createFileRoute("/")({
    ...
    head: () => ({
        meta: [
            {
                title: "Vox Prismatic | Fractional executives on LinkedIn, without the grind",
            },
            {
                name: "description",
                content:
                    "Vox Prismatic helps fractional executives turn transcripts and briefings into polished LinkedIn posts. Stay visible across every portfolio without rewriting the same story twice.",
            },
        ],
    }),
});
      ...
      <div className="bg-white text-zinc-900">
          ...
          <header className="border-b border-zinc-200">
              <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
                  ...
                  >
                      <div
                          className="h-9 w-9 rounded-lg bg-blue-600"
                          aria-hidden="true"
                      />
                      Vox Prismatic
                  </Link>
          ...
          <main
              id="main-content"
              className="mx-auto flex max-w-6xl flex-col gap-24 px-6 pb-24 pt-16"
          >
              <section className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                  <div className="space-y-6">
                      ...
                      <p className="text-lg text-zinc-600">
                          Vox Prismatic gives fractional executives a
                          project-centric workflow that transforms board
                          updates, portfolio wins, and advisory calls into
                          ready-to-publish LinkedIn posts—without late-night
                          writing sprints.
                      </p>
                      <div className="flex flex-wrap items-center gap-3">
                          ...
                          {isAuthenticated ? (
                              <Button
                                  ...
                                  variant="outline"
                                  size="lg"
                                  className="h-12 border-zinc-300 px-6 text-base"
                              >
                                  <Link
                                      to="/projects/new"
                                      className="flex items-center gap-2"
                      ...
                      <div className="space-y-6">
                          <div className="flex items-center justify-between">
                              <div>
                                  ...
                                  <p className="text-xl font-semibold text-zinc-900">
                                      Portfolio sync · Series B fintech
                                  </p>
                              </div>
                              <Badge
                                  variant="secondary"
                          ...
                          <div className="rounded-xl border border-dashed border-zinc-200 bg-white p-4 shadow-sm">
                              ...
                              <p className="mt-2 text-base font-medium text-zinc-900">
                                  “Fractional doesn’t mean part-time influence.
                                  Here’s how we turned a board fire drill into a
                                  customer story our network couldn’t stop
                                  sharing.”
                              </p>
                          ...
                          <div className="flex items-center justify-between text-xs text-zinc-500">
                              <span>
                                  Briefing processed via SSE · 3 mins ago
                              </span>
              ...
              >
                  <div className="flex items-center gap-3 text-sm font-medium uppercase tracking-[0.2em] text-zinc-500">
                      ...
                      <span id="social-proof-heading">
                          Trusted by fractional leaders
                      </span>
                  </div>
                  <div className="flex flex-wrap items-center gap-6 text-base text-zinc-500">
                      {socialProof.map((group) => (
                          <span
                              key={group}
                              className="whitespace-nowrap rounded-full border border-zinc-200 px-4 py-2"
                          >
                              {group}
                          </span>
                      ))}
              ...
              >
                  <div className="max-w-3xl space-y-4">
                      ...
                      >
                          Replace disconnected tools with a workflow that keeps
                          you visible while you operate.
                      </h2>
                      <p className="text-lg text-zinc-600">
                          Vox Prismatic removes the manual labor of turning
                          calls into content so you can focus on steering
                          portfolio strategy, not polishing posts.
                      </p>
                  </div>
                  <div className="grid gap-6 md:grid-cols-3">
                      {differentiators.map(
                          ({ title, description, icon: Icon }) => (
                              <Card
                                  key={title}
                                  className="h-full border-zinc-200 shadow-sm"
                              >
              ...
              <section
                  ...
                  className="grid gap-10 lg:grid-cols-[0.6fr_1fr] lg:items-center"
              >
                  <div className="space-y-4">
                      ...
                      <p className="text-lg text-zinc-600">
                          Guided stages keep every engagement moving—from first
                          briefing to scheduled post—with clarity on who owns
                          the next action.
                      </p>
                      <Button
                          asChild
                          size="lg"
                          className="h-12 w-fit px-6 text-base"
                      >
              ...
              <section aria-labelledby="results-heading" className="space-y-12">
                  <div className="max-w-3xl space-y-4">
                      <h2
                          ...
                          className="text-3xl font-semibold text-zinc-900"
                      >
                          Fractional executives convert conversations into
                          influence faster.
                      </h2>
                      <p className="text-lg text-zinc-600">
                          See the compound impact when each strategic call fuels
                          LinkedIn content that keeps every stakeholder looped
                          in.
                      </p>
                  </div>
                  <div className="grid gap-6 md:grid-cols-3">
              ...
              <section
                  ...
                  className="rounded-3xl border border-zinc-200 bg-gradient-to-r from-zinc-50 to-blue-50 p-10 shadow-sm"
              >
                  <div className="max-w-3xl space-y-6">
                      ...
                      <h2
                          ...
                          className="text-3xl font-semibold text-zinc-900"
                      >
                          “We translate portfolio wins into LinkedIn narratives
                          before the next standup even starts.”
                      </h2>
                      <p className="text-lg text-zinc-700">
                          “Before Vox Prismatic I was copying field notes into
                          docs on Friday nights. Now I forward a briefing,
                          review aligned drafts in minutes, and my network sees
                          the signal the same day. It’s the operating system
                          that keeps every portfolio company aligned with my
                          executive narrative.”
                      </p>
                      <div className="text-sm font-medium text-zinc-600">
                          — Priya Raman, Fractional CMO at Signal North
                          Collective
                      </div>
                  </div>
              </section>
              ...
              <section aria-labelledby="faq-heading" className="space-y-10">
                  <div className="max-w-3xl space-y-4">
                      ...
                      <p className="text-lg text-zinc-600">
                          Everything you need to know before turning your
                          advisory calls into a consistent executive presence.
                      </p>
                  </div>
                  <div className="space-y-6">
                      {faqs.map((faq) => (
              ...
              <section
                  ...
                  className="rounded-3xl border border-zinc-200 bg-zinc-900 p-10 text-white shadow-lg"
              >
                  <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                      <div className="space-y-4">
                          ...
                          >
                              Ready to ship LinkedIn thought leadership on
                              autopilot?
                          </h2>
                          <p className="text-lg text-zinc-200">
                              Launch your first project in minutes. Import a
                              briefing, review AI drafts, and publish to
                              LinkedIn before the next board packet lands.
                          </p>
                      </div>
                      <div className="flex flex-wrap items-center gap-3">
                          <Button
                              ...
                              size="lg"
                              variant="secondary"
                              className="h-12 px-6 text-base text-zinc-900"
                          >
                              <Link
                                  to={primaryCtaHref}
                                  className="flex items-center gap-2"
                          ...
                          <Button
                              ...
                              size="lg"
                              variant="outline"
                              className="h-12 border-white px-6 text-base text-white"
                          >
                              <a href="mailto:hello@contentprojects.com">
                                  Talk with sales
                              </a>
                          </Button>
                      </div>
          ...
          <footer className="border-t border-zinc-200 bg-zinc-50">
              <div className="mx-auto flex max-w-6xl flex-col gap-4 px-6 py-8 text-sm text-zinc-500 sm:flex-row sm:items-center sm:justify-between">
                  <p>
                      &copy; {new Date().getFullYear()} Vox Prismatic. All
                      rights reserved.
                  </p>
                  <div className="flex flex-wrap items-center gap-4">
                      ...
                      <a
                          href="mailto:hello@contentprojects.com"
