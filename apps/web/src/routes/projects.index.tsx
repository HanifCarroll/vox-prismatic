      ...
      <div className="p-6">
          ...
          {items.length === 0 ? (
              <div className="mt-16 flex flex-col items-center text-center text-zinc-600">
                  ...
                  >
                      <title id="projects-empty-icon-title">
                  ...
                  <p className="mt-1 max-w-md text-sm">
                      Spin up your first project to turn a transcript into a set
                      of LinkedIn-ready posts.
                  </p>
                  <Link to="/projects/new" className="mt-4 inline-flex">
                      <span className="inline-flex items-center rounded-md border px-3 py-1.5 text-sm font-medium hover:bg-zinc-50">
              ...
              <ul className="space-y-2">
                  {items.map((p) => (
                      <li
                          key={p.id}
                          className="border rounded p-3 hover:bg-zinc-50"
                      >
...
export const Route = createFileRoute('/projects/')({
  ...
  // Load the projects list for the index view (client-only after auth)
