...
- HTTP Client: Orval-generated React Query hooks with Axios (auto-updated via CI)
...
> **Note:** The OpenAPI spec (`apps/web/openapi.json`) is auto-generated by CI when API code changes. For production builds, the committed spec file is used instead of the live API endpoint.
